...
class _DashboardState extends State<Dashboard> {
  List<dynamic> Tittle = ['Apples', 'Redberries', 'Banana', 'Strawberry'];
  List<dynamic> doller = ['Only \$20', 'Only \$20', 'Only \$20', 'Only \$20'];
  List<dynamic> images = [
    'images/apple.png',
  ...
  List<dynamic> doller1 = ['Only \$20', 'Only \$20', 'Only \$20', 'Only \$20'];
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                        return InkWell(
                          ...
                          child: dashboard_new(
                              images:
                                  'http://jayanthi10.pythonanywhere.com${list!.data![index].image}',
